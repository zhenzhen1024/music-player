<template>
    <div class="player" v-show="playlist.length>0">
      ...
      <transition name="mini">
        ...
        <div class="icon">
          <img :class="cdCls" width="45" height="45" :src="currentSong.image">
        </div>
        <div class="text">
      ...
      <audio ref="audio" :src="currentSongUrl" @play="ready"
...
export default {
  ...
  methods: {
    ...
    _getSongUrl() {
      let url = ''
      getSong(this.currentSong).then((res) => {
        if (res) {
          url = 'http://dl.stream.qqmusic.qq.com/' + res.req_0.data.midurlinfo[0].purl
